...
class SlackJob(job.JobBase):
    ...
    def meta_info(cls):
        return {
            ...
            "notes": (
                "This sends message to a Slack channel. To run this job, you have to run "
            ...
            "example_arguments": (
                '["#slack-bot-test", "ndscheduler chat bot", ":satisfied:",'
    ...
    def run(self, channel, name, icon_emoji, message, *args, **kwargs):
        ...
        try:
            ...
            logger.error(
                "Environment variable SIMPLE_SCHEDULER_SLACK_URL is not specified. "
